...
-Scopes can also be nestted, where there is an outer scope (think global scope) that encloses an inner scope (think local scope)
...
-var and let seem to operate the same. While they have a lot of the same functionality, they behave a little differently.
