/*
-Switch statements execute a block of cod depending on different
cases
...
default keyword(or both). They are both optional
    ...
    block. If break is ommitted,the next code block in the switch
    statment is executed.
    -The default keyword specifies some code to run of there is no
...
switch (officeCharacter) {
    ...
    case "Kevin":
        console.log("A mistake plus kelvin gets you home by seven");
        break;
...
let dessertMenuItem = "Pie"

switch (dessertMenuItem) {
    case "Pie":
    ...
    default:
        console.log(`${dessertMenuItem}, is not on the menu.`);
}